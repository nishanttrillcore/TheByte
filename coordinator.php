...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar fixed-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <a class="navbar-brand" href="#">The Byte | Coordinator Panel </a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:setURL('/thebyte/userdashboard.php');" target=container-fluid><i class="fa fa-fw fa-institution"></i> Home</a>
                </li>
				<li class="nav-item">
                    ...
                    <ul class="sidebar-second-level collapse" id="collapseMulti">
                        <li>
                            <a href="javascript:setURL('/thebyte/coordinator/eventcontrico.php');">Create Event</a>
                        </li>
                        <li>
                            <a href="javascript:setURL('/thebyte/coordinator/eventsuco.php');">My Event</a>
                        </li>
                        <li>
                            <a class="nav-link-collapse collapsed" data-toggle="collapse" href="#collapseMulti2">Approve Payment</a>
                            <ul class="sidebar-third-level collapse" id="collapseMulti2">
                                <li>
                                    <a href="javascript:setURL('/thebyte/coordinator/coofline.php');">OFFLINE</a>
                                </li>
                                <li>
                                    <a href="javascript:setURL('/thebyte/coordinator/ghpaytmapp.php');">PAYTM </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
				...
				<li class="nav-item">
                    <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents"><i class="fa fa-fw fa-newspaper-o"></i> Byte</a>
                    <ul class="sidebar-second-level collapse" id="collapseComponents">
                        <li>
                            <a href="#">Approve Article</a>
                        </li>
                        <li>
                            <a href="#">All Submissions</a>
                        </li>
                        <li>
                            <a href="#">Upload Magazine</a>
                        </li>
                        <li>
                            <a href="#">Delete Magazine</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa fa-fw fa-id-card-o"></i> Allot Certificate</a>
                </li>
   ...
   ?></a>
    ...
    <div class="content-wrapper py-3">
        <div class="container-fluid" style="overflow:auto;border:0px ridge orange position:  margin:0px;padding:0px;relative;top:0;left:0;bottom:0;right:0;width: 100%;height: 100%;;display:block;height=100%;">
