...
if($_SESSION["usersid"]==$rowsess["sessionid"]){
...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
		...
		<a class="navbar-brand" href="#">The Byte | Incharge Panel</a>
        
		<div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:setURL('/thebyte/userdashboard.php');" target=container-fluid><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
                <li class="nav-item">
