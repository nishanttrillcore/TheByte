...
<body id="page-top">
<!--when not login but homepage kholta to -->
    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <a class="navbar-brand" href="#">The Byte</a>
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:setURL('/thebyte/new.php');" target=container-fluid><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="loginscree.php"><i class="fa fa-fw fa-user-circle "></i>Login</a>
                </li>
            </ul>
        </div>
    </nav>
    <!-- Icon Cards -->
	<!-- Main upar wala chalu yaha se -->
	 ...
	 <div class="row">
      ...
      <!--yaha per upar wala khatm -->
        ...
        <div class="container-fluid" style="overflow:auto;border:0px ridge orange position:  margin:0px;padding:0px;relative;top:0;left:0;bottom:0;right:0;width: 100%;height: 100%;;display:block;height=100%;">
             ...
             <object type="text/html" class=ty id=iframe data="/thebyte/" width="100%"   style=" display:block;height: 1100px; margin:0px;padding:0px;border:0px ridge orange" >
             </object>
